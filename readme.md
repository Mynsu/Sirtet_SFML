...
+ [**OFL**](https://scripts.sil.org/OFL) (for fonts)


저와 이 코드에 대해 궁금하실 만한 것들을 미리 추려봤습니다.   
------------------------------------------------------
**#깃 브랜칭 모형** **#깃 플로**   
...
**#이름 공간과 파일 디렉토리 일치**   
  예로, 클래스 ::scene::inPlay::Ready를 선언, 정의한 파일은 *dlls/Game/scene/inPlay/* 아래에 있습니다.   
